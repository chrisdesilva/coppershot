      ...
      <Grid stackable>
        <Grid.Row>
          <Grid.Column width={8}>
            ...
            <p>
            Copper Shot Distillery hand crafts all of their American distilled spirits on-site with rainwater and local grains and is made in small batches. The small batch process is what creates the quality and leads to the best flavor. Crafting spirits is a very hands-on process and is a lot like science and engineering all in one. You can recognize most of our products that are distributed in liquor stores by our business logo, an engraved copper shot glass on top of the bottle. Hence how the name Copper Shot was created. 
            </p>
            <p>
            **** For bottles purchased directly from the distillery, we give you the option to purchase with or without the copper shot glass. **** 
            </p>
            <p>
